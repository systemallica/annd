...
% Tries to assign new point to the closest attractor(patter that we wanna recognise)-> classification
net = newhop(T);
...
% to create it. But there can be more because the degrees of freedom are not enough
% for blablabla.
